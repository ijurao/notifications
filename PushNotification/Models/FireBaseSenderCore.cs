...
{
    public class FireBaseSenderCore:IDisposable
    {
        ...
        public FireBaseSenderCore(string serverKey, string senderId)
        {
        ...
        public async Task<FireBaseResponse> SendAsync(string deviceId, object payload)
        {
            ...
            return JsonHelper.Deserialize<FireBaseResponse>(responseString);
        }
